...
public class RavenousWolf extends WolfBase {
    protected boolean stopAttacking = false;
    
    public RavenousWolf(double x, double y) {
        super(x,y);
        this.health = 16;
        this.maxHealth = 16;
        this.healing = 0;
    ...
    public void control() {
        ...
        if (!this.stopAttacking && !this.PANIC && !this.stopHoming && this.target != null) {
    ...
    public void render(Graphics2D g) {
        ...
        g.drawImage(main.rwolfA.get(i.toString()), (int)Math.round(this.x)-12, (int)Math.round(this.y)-15, null);
