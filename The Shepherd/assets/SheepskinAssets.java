...
public class SheepskinAssets {
    HashMap<String, BufferedImage> sprites = new HashMap<String, BufferedImage>();
    public SheepskinAssets() {
        final int sx = 24, sy = 16, f = 8;
        InputStream tmp = getClass().getResourceAsStream("/assets/sheepskin.png");
        Image img = null;
        try {
        ...
        String[] n = {"idle","walk1","walk2","idle_back","walk1_back","walk2_back","dead","dead_back"};
