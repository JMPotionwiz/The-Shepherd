...
public class SheepAssets {
    HashMap<String, BufferedImage> sprites = new HashMap<String, BufferedImage>();
    public SheepAssets() {
        final int sx = 16, sy = 16, f = 15;
        InputStream tmp = getClass().getResourceAsStream("/assets/sheep.png");
        Image img = null;
        try {
        ...
        String[] n = {"idle","walk1","walk2","idle_back","walk1_back","walk2_back","idle_hurt","walk1_hurt","walk2_hurt","idle_hurt_back","walk1_hurt_back","walk2_hurt_back","dead","dead_back","fall"};
