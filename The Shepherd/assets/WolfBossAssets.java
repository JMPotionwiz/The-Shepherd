...
public class WolfBossAssets {
    HashMap<String, BufferedImage> sprites = new HashMap<String, BufferedImage>();
    public WolfBossAssets() {
        final int sx = 24, sy = 16, f = 12;
        InputStream tmp = getClass().getResourceAsStream("/assets/wolf_boss.png");
        Image img = null;
        try {
        ...
        String[] n = {"idle","walk1","walk2","walk3","idle_back","walk1_back","walk2_back","walk3_back","howl","howl_back","dead","dead_back"};
