...
public class Window extends JFrame {
    ...
    public void legacyRender(HashSet<Entity> E, ArrayList<ArrayList<Button>> B) {
        ...
        switch (main.menu) {
            ...
            case 3:
                ...
                } else if (main.lastAttackBySheepskin == true) {
                    g.drawImage(main.sheepskinA.get("idle"), 0 - 8, -24 - 15, null);
                    renderText(g, "Beware the wolf in sheep's clothes", 0 - (int)(getTextWidth("Beware the wolf in sheep's clothes") * 0.5), -16);
                } else {
    ...
    public void render(HashSet<Entity> E, ArrayList<ArrayList<Button>> B) {
        ...
        Graphics2D g1 = (Graphics2D) c.getGraphics();
        g1.translate(getSize().width * 0.5, getSize().height * 0.5);
        int s;
        if (getSize().width < getSize().height) {
            s = getSize().width;
        } else s = getSize().height;
